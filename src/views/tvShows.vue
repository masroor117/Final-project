...
<script>
    ...
    export default {
        ...
        methods:
            {
                ...
                async requestEntertainment(page) {
                    const res = await axios.get(
                        `https://api.themoviedb.org/3/discover/tv?api_key=6800472317f51741b9b808a5af9ee6a1&language=en-US&sort_by=popularity.desc&include_adult=true&include_video=false&page=${page}`
                    );
        ...
        //intializes fields with important information such as IDs, images length etc. to clean up code
        computed: {
            duration() {
